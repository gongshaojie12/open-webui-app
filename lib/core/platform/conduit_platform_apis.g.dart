...
class PlatformAppIntentResponse {
  ...
  List<Object?> _toList() {
    return <Object?>[success, value, error];
  }
...
class PlatformNativeSheetItem {
  ...
  static PlatformNativeSheetItem decode(Object result) {
    ...
    return PlatformNativeSheetItem(
      ...
      subtitle: result[2] as String?,
      sfSymbol: result[3]! as String,
      destructive: result[4]! as bool,
      url: result[5] as String?,
      kind: result[6]! as PlatformNativeSheetItemKind,
      value: result[7],
      placeholder: result[8] as String?,
      options: (result[9]! as List<Object?>).cast<PlatformNativeSheetOption>(),
      sourceIndex: result[10] as int?,
      sourceUrl: result[11] as String?,
      sourceType: result[12] as String?,
      snippet: result[13] as String?,
      faviconUrl: result[14] as String?,
      queries: (result[15]! as List<Object?>).cast<String>(),
      links: (result[16]! as List<Object?>).cast<PlatformNativeSheetLink>(),
      pending: result[17]! as bool,
      min: result[18] as double?,
      max: result[19] as double?,
      divisions: result[20] as int?,
    );
  }
...
class PlatformNativeSheetModelSelectorRequest {
  ...
  static PlatformNativeSheetModelSelectorRequest decode(Object result) {
    ...
    return PlatformNativeSheetModelSelectorRequest(
      ...
      models: (result[2]! as List<Object?>)
...
class PlatformNativeSheetApplyDetailPatchRequest {
  ...
  List<Object?> _toList() {
    return <Object?>[detailId, items, title, subtitle, detailSheets];
  }
  ...
  static PlatformNativeSheetApplyDetailPatchRequest decode(Object result) {
    ...
    return PlatformNativeSheetApplyDetailPatchRequest(
      ...
      detailSheets: (result[4] as List<Object?>?)
          ?.cast<PlatformNativeSheetDetail>(),
    );
  }
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final PlatformAppIntentImagePayload arg_payload =
              args[0]! as PlatformAppIntentImagePayload;
          try {
